#!/usr/bin/env zsh
# iTerm2 user variable integration for zsh
# Source this file in your ~/.zshrc to export environment variables to iTerm2
...
add-zsh-hook precmd iterm2_update_user_vars
